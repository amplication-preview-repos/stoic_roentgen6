...
const CREATE_INPUT = {
  attempts: 42,
  billingid: "exampleBillingid",
  billingusers: "exampleBillingusers",
  createdAt: new Date(),
  ...
  test("POST /accounts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastUpdateDate: CREATE_RESULT.lastUpdateDate.toISOString(),
      ...
      .expect([
        {
          ...
          lastUpdateDate: FIND_MANY_RESULT[0].lastUpdateDate.toISOString(),
  ...
  test("GET /accounts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        lastUpdateDate: FIND_ONE_RESULT.lastUpdateDate.toISOString(),
